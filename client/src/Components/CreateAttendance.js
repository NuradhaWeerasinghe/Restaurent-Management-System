...
//                 <div className="form-group col-4 position-relative" style={{marginTop:'15px'}}>
// 	            <label for="type">Attendance Type : </label>
// 	            <select id="type" className="form-control" name="leaveType" onChange={this.handleInputChange} value={this.state.type} required>
...
//                 <div className="form-group" style={{marginBottom:'15px'}}>
//                 <label style={{marginBottom:'5px'}}>Select Date & Time</label>
//                 <input type="datetime-local"
//                 className="form-control"
//                 name="aTime"
